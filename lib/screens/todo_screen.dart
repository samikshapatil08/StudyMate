...
import 'package:table_calendar/table_calendar.dart'; // ✅ Required
...
class _TodoScreenState extends State<TodoScreen> {
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                /// 🗓️ VIEW TOGGLE BUTTON
                BlocBuilder<TodoBloc, TodoState>(
                  builder: (context, state) {
                    bool isCalendar = false;
                    if (state is TodosLoaded) isCalendar = state.isCalendarView;
                    return IconButton(
                      icon: Icon(
                ...
                /// 🔽 SORT / FILTER BUTTON (Restored Checkmarks)
                BlocBuilder<TodoBloc, TodoState>(
                  builder: (context, state) {
        ...
        child: Container(
          ...
          child: ListTile(
            leading: Checkbox(
              ...
              onChanged: (val) => context.read<TodoBloc>().add(
                TodoToggleRequested(todo.id, val ?? false),
              ),
            ),
            title: Text(
              data['title'] ?? '',
  ...
  // ✅ RESTORED: Dialog with Date Picker & Visible Header
            ...
            return AlertDialog(
              ...
              actions: [
                ...
                TextButton(
                  onPressed: () {
                    context.read<TodoBloc>().add(
                      TodoAddRequested(controller.text, deadline: selectedDate),
                    );
